...
<html>
    ...
    <body>
        ...
        String userid=request.getParameter("iidd");
         String name=null ,email=null ,mob=null,Licence=null;
          try{
        Class.forName("com.mysql.cj.jdbc.Driver");
        Connection cn=DriverManager.getConnection("jdbc:mysql://localhost:3306/rest","root","");
        Statement smt=cn.createStatement();
        
ResultSet rs=smt.executeQuery("select * from dregister where userid="+userid);
while(rs.next())
{
   name=rs.getString(2);
   email=rs.getString(3);
   mob=rs.getString(5);
   Licence=rs.getString(6);
}
...
cn.close();   
        ...
        %>
        <form action="D_Update.jsp" method="post">
            <pre>
